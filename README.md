...
| Experiment | Topic | Programs | Algorithm |
|:-:|:---|:-:|:---|
| **1** | Line Drawing & Basic Shapes | 2 | Bresenham's Algorithm, Graphics Primitives |
| **2** | Circle Drawing | 1 | Midpoint Circle Algorithm |
| **3** | Ellipse Drawing | 1 | Midpoint Ellipse Algorithm |
